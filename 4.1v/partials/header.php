...
// require '../vertinimas/markData.php';
?>
<!DOCTYPE html>
<html class="op"><head>
    ...
    <link href="../styles/TamoSession.css" media="all" rel="stylesheet" type="text/css">

    <script src="../scripts/jquery.js"></script>
    <script src="../scripts/jquery.ui.js"></script>
    <script src="../scripts/tamo.js"></script>
</head>

<body class="container">
    
<div class="loader " id="loader">
    <img src="../images/owl_gif.gif">
</div>
    ...
    <div class="col-md-14">
        <div class="row top_section_back">
            <div class="col-md-10">
                ...
                <span style="vertical-align:middle;display:table-cell;height:40px;font-size:16px;font-weight:600;padding-left:15px;">Tauragės Žalgirių gimnazija</span>
...
<div id="header_section" class="row">
    <div class="col-md-14">
        <div style="height:88px;background:white;">
            <a href="../Prisijungimas/Naujienos"><img src="../images/logo.png" style="margin:20px 15px; display:inline-block;float:left"></a>
                    ...
                    <div style="display:table-cell;vertical-align:middle;">
                        <div style="display:table;height:51px;border-left:1px solid #e8e8e8;">
                            <div style="display:table-cell;vertical-align:middle;padding:0 30px;position:relative">
                                <a href="javascript:void(0);"><img style="vertical-align:middle;" src="../images/head.png"></a>
                                <div style="display:inline-block;vertical-align:middle;">
                                    <div style="font-size:14px;font-weight:600;"><?= $first_name.' '.$last_name ?></div>
                                    <div class="c_select_box auto_hide_button inactive">
                                        <a class="c_select_box_link" onclick="Dropdown();">
Mokinys                                            <!--<div class="drop_icon"></div>-->
...
Mokinys                                                                    <span class="role_name">
                                                                         
                                                                    </span>
                                                                    <span class="role_details">Tauragės Žalgirių gimnazija</span>
                                                                </span>
                                                        </div>
                                                    </a>
                                                    <a href="../Administravimas/Pazymiai" target="_blank">
                                                    <div class="c_select_options_item">
                                                            <i class="fa fa-cogs fa-2x fa-fw" aria-hidden="true"></i>
                                                            <span class="role_title">Administravimas</span>
                                                    </div>
                                                </a>
            ...
            <div id="infobar" class="session_background" style="height:31px;">
                ...
                <div style="display:inline-block;float:right;">
                    <div style="border-left:solid 1px #e8e8e8;padding:0 0px 0 15px;margin-top:8px;height:15px;display:inline-block;">
                        <img src="../images/clock.png" style="vertical-align:top;">
                    </div>
