...
<head>
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,500,600,700&amp;subset=latin-ext"
        ...
        <div class="col-md-14">
            <div class="row top_section_back">
                ...
                <div class="col-md-4">
                    ...
                    <div class=""
                        style="display:inline-block;height:40px;vertical-align:middle;width:100%;padding-right:15px;font-weight:600">

                        <span style="float:right;line-height:40px;"> Apkrovimas:<a id="sysInfo"
                                href="javascript:void(0);"><span class="sysinfo-text">NORMALUS</span><span
                                    id="sysinfo-icon" class="fa fa-circle" style="color: #61d462;"></span><span
                                    id="sysinfo-loading" class="hidden"><i
                                        class="fa fa-spinner fa-pulse fa-lg fa-fw"></i></span></a></span>
                    </div>
        ...
        <div class="col-md-14">
            <div style="height:88px;background:white;">
                <a href="#"><img src="../static/images/logo.png"
                        style="margin:20px 15px; display:inline-block;float:left"></a>
                                                ...
                                                <div class="c_select_options hidden auto_hide dropdown-content"
                                                    ...
                                                    <a href="../Prisijungimas/logout.php" onclick="">
                                                        <div class="c_select_options_item">
                                                            <i class="fa fa-lock fa-2x fa-fw icon_red"
                                                                aria-hidden="true"></i>
    ...
    <div id="session_section" class="row">
        <div class="col-md-14">
            <div id="infobar" class="session_background" style="height:31px;">
                <span id="infobar_message"
                    style="color:white;font-weight:bold;padding-left:15px;line-height:31px"></span>
                <div style="display:inline-block;float:right;">
                    <div
                        style="border-left:solid 1px #e8e8e8;padding:0 0px 0 15px;margin-top:8px;height:15px;display:inline-block;">
                ...
                <div class="ui-pnotify  ui-pnotify-fade-normal ui-pnotify-mobile-able ui-pnotify-in ui-pnotify-fade-in ui-pnotify-move"
                    ...
                    <div id="response_window" class="brighttheme ui-pnotify-container brighttheme-success ui-pnotify-shadow" role="alert"
                        style="min-height: 16px; display: none;">
                        ...
                        <div class="ui-pnotify-sticker" aria-role="button" aria-pressed="false" tabindex="0"
                            title="Stick" style="cursor: pointer; visibility: hidden;"><span
                                class="brighttheme-icon-sticker" aria-pressed="false"></span></div>
                        <div class="ui-pnotify-icon"><span class="brighttheme-icon-success"></span></div>
                        <h4 class="ui-pnotify-title" id="response_title"></h4>
                        <div class="ui-pnotify-text" aria-role="alert" id="response_content"></div>
